...
const services = [
  // Chiropractic
  { id: S(1), slug: 'manual-adjustment', category: 'Chiropractic', name: 'Manual Adjustment', durationMin: 30, bufferMin: 5, requiredRole: StaffRole.CHIROPRACTOR, resourceType: 'ADJUSTING_ROOM' , priceCents: 5500, newPatientSlug: 'spinal-postural-exam' , color: 'chiro_saddle' },
  { id: S(2), slug: 'spinal-postural-exam', category: 'Chiropractic', name: 'Spinal & Postural Exam', durationMin: 45, bufferMin: 10, requiredRole: StaffRole.CHIROPRACTOR, resourceType: 'ADJUSTING_ROOM' , priceCents: null , color: 'chiro_golden' },
  { id: S(3), slug: 'spinal-xrays', category: 'Chiropractic', name: 'Spinal X-Rays', durationMin: 30, bufferMin: 10, requiredRole: StaffRole.CHIROPRACTOR, resourceType: 'XRAY_SUITE' , priceCents: 25000, priceNote: 'Exam & full spine X-rays' , color: 'chiro_peru' },

  // Functional Medicine
  { id: S(4), slug: 'functional-medicine-consult', category: 'Functional Medicine', name: 'Functional Medicine Consult', durationMin: 30, bufferMin: 10, requiredRole: StaffRole.NURSE_PRACTITIONER, resourceType: 'CONSULT_ROOM' , priceCents: 15000, priceNote: '30 minute consult — includes InBody body composition measuring' , color: 'fm_hunter' },
  { id: S(5), slug: 'biomarker-testing', category: 'Functional Medicine', name: 'Biomarker Testing', durationMin: 20, bufferMin: 5, requiredRole: StaffRole.REGISTERED_NURSE, resourceType: 'LAB_DRAW' , priceCents: null, priceNote: 'Price varies by panel' , color: 'fm_jade' },
  { id: S(6), slug: 'hormone-optimization', category: 'Functional Medicine', name: 'Hormone Optimization', durationMin: 30, bufferMin: 10, requiredRole: StaffRole.NURSE_PRACTITIONER, resourceType: 'CONSULT_ROOM' , priceCents: 35000, priceNote: 'Walk-in — includes DUTCH testing and 30 minute consult' , color: 'fm_grass' },
  { id: S(7), slug: 'body-composition', category: 'Functional Medicine', name: 'Body Composition', durationMin: 15, bufferMin: 5, requiredRole: StaffRole.REGISTERED_NURSE, resourceType: 'INBODY_STATION' , priceCents: 5500, priceNote: 'Walk-in rate' , color: 'fm_forest' },
  { id: S(8), slug: 'supplementation', category: 'Functional Medicine', name: 'Supplementation', durationMin: 20, bufferMin: 5, requiredRole: StaffRole.NURSE_PRACTITIONER, resourceType: 'CONSULT_ROOM' , priceCents: null , color: 'fm_lime' },
  { id: S(9), slug: 'personal-wellness-planning', category: 'Functional Medicine', name: 'Personal Wellness Planning', durationMin: 45, bufferMin: 10, requiredRole: StaffRole.NURSE_PRACTITIONER, resourceType: 'CONSULT_ROOM' , priceCents: null , color: 'fm_shamrock' },

  // Longevity
  { id: S(10), slug: 'iv-therapy', category: 'Longevity', name: 'IV Therapy', durationMin: 60, bufferMin: 15, requiredRole: StaffRole.REGISTERED_NURSE, resourceType: 'IV_CHAIR' , priceCents: 18500, priceNote: 'Members save 25%. Two per month included with Optimize.' , color: 'long_sky' },
  { id: S(11), slug: 'vitamin-shots', category: 'Longevity', name: 'Vitamin Shots', durationMin: 15, bufferMin: 5, requiredRole: StaffRole.REGISTERED_NURSE, resourceType: 'SHOT_ROOM' , priceCents: null, priceNote: 'Price varies by shot' , color: 'long_periwinkle' },
  { id: S(12), slug: 'hyperbaric-oxygen-therapy', category: 'Longevity', name: 'Hyperbaric Oxygen Therapy (60 min)', durationMin: 60, bufferMin: 15, requiredRole: StaffRole.REGISTERED_NURSE, resourceType: 'CHAMBER' , priceCents: 11000 , color: 'long_cobalt' },
  { id: S(13), slug: 'hyperbaric-oxygen-therapy', category: 'Longevity', name: 'Hyperbaric Oxygen Therapy (90 min)', durationMin: 90, bufferMin: 15, requiredRole: StaffRole.REGISTERED_NURSE, resourceType: 'CHAMBER' , priceCents: 16500 , color: 'long_cobalt' },
  { id: S(14), slug: 'red-light-therapy', category: 'Longevity', name: 'Red Light Therapy', durationMin: 10, bufferMin: 5, requiredRole: StaffRole.REGISTERED_NURSE, resourceType: 'RED_LIGHT_BED' , priceCents: 5500, priceNote: 'Full-dose 10 minute session — 3 credits' , color: 'long_midnight' },
  { id: S(15), slug: 'peptide-therapy', category: 'Longevity', name: 'Peptide Therapy', durationMin: 30, bufferMin: 10, requiredRole: StaffRole.NURSE_PRACTITIONER, resourceType: 'CONSULT_ROOM' , priceCents: null, priceNote: 'Pricing varies by prescription — reviewed with you during your consultation.' , color: 'long_ice' },
];
